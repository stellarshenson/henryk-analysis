...
```json
{
  ...
  "transcription_overview_dad_perspective": "longer summary of the transcription told from 1st perspective - by the dad to his 3 years old son. This must take a form of a teaser, not revealing too much and encouraging son to get the full story (but not explicitly). This overview must be expressed in Polish language, using light, child-friendly tone and language. This overview should be approx. 300 words, but it is ok if it is longer",
...
```json
{
  "approach": {
    ...
    "transcription_overview_dad_perspective": "Examine the transcription and distill the most important parts of it. Next provide a brief overview of the story using light tone and not revealing too much information.",
  ...
  "justification": {
    "why": {
      ...
      "transcription_overview_dad_perspective" "The overview focuses on the key parts of the transcription - father's visit and short seeing, plans for the future and activities with cousins and a short overview of the fairy tale.",
    ...
    "where": {
      ...
      "transcription_overview_dad_perspective" "'Widziałem Cię na krótką chwilkę. Na bardzo krótką chwilkę. ', 'Mama i tata, próbujemy zrobić wszystko, Henryczku, żebyś mógł mieć na z oboje', 'Bo jutro będę spędzał czas z Twoimi kuzynami. Z Arturkiem i z Filipem. I wiesz, co będziemy robić? Będziemy robić latawce', '. Dinozaury Henryczku przypominają smoki z opowieści', 'Dawno, dawno, dawno temu. To znaczy 100 milionów lat temu żyły dinozaury. ', 'Dookoła rosły ogromne skrzypy i ogromne paprocie.', 'były tak wielkie i tak różne, że trudno się ich naliczyć. Niektóre dinozaury były bardzo długie i chodziły na czterech łapach'",
      "other": "No additional details were necessary."
    }
  },
