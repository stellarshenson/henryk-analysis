...
DIR_TRANSCRIPTIONS_DOC = '/mnt/onedrive/My\ Private/My\ Documents/Other/Henryk/Alienacja\ rodzicielska\ materiały/Wiadomości\ do\ Henryczka/transkrypcje'
DIR_TRANSCRIPTIONS = '../../data/processed/transcriptions'
DIR_FIGURES = '../../reports/recordings'


# ai
FILE_PROMPT_RECORDING_CLASSIFICATION = '../../resources/prompt_recording_classification.md'
